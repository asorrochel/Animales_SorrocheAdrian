...
public class listarAnimalesTerrestres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_animales_terrestres);

        toolbar = findViewById(R.id.toolbar_terrestres);
        animales = findViewById(R.id.rcv_animalesTerrestres);
    ...
    private void mostrarTodosAnimales(String condicionOrdenar) {
        ...
        AdapterAnimal adapter = new AdapterAnimal(this, claseBD.searchAnimales("TIPO","terrestre"));
    ...
    private void setToolbar(androidx.appcompat.widget.Toolbar toolbar) {
        ...
        getSupportActionBar().setTitle("Animales Terrestres");
