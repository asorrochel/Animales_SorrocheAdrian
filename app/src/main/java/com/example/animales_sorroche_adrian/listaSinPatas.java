...
public class listaSinPatas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_sin_patas);

        toolbar = findViewById(R.id.toolbar_sinPatas);
        animales = findViewById(R.id.rcv_sinPatas);
    ...
    private void mostrarTodosAnimales(String condicionOrdenar) {
        ...
        AdapterAnimal adapter = new AdapterAnimal(this, claseBD.searchAnimales("PATAS","0"));
    ...
    private void setToolbar(androidx.appcompat.widget.Toolbar toolbar) {
        ...
        getSupportActionBar().setTitle("Animales sin patas");
