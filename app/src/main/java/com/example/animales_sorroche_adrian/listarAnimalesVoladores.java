...
public class listarAnimalesVoladores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_animales_voladores);

        toolbar = findViewById(R.id.toolbar_voladores);
        animales = findViewById(R.id.rcxv_animalesVoladores);
    ...
    private void mostrarTodosAnimales(String condicionOrdenar) {
        ...
        AdapterAnimal adapter = new AdapterAnimal(this, claseBD.searchAnimales("TIPO","aéreo"));
    ...
    private void setToolbar(androidx.appcompat.widget.Toolbar toolbar) {
        ...
        getSupportActionBar().setTitle("Animales Aéreos");
