...
public class lista4Patas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista4_patas);

        toolbar = findViewById(R.id.toolbar_4Patas);
        animales = findViewById(R.id.rcv_4Patas);
    ...
    private void mostrarTodosAnimales(String condicionOrdenar) {
        ...
        AdapterAnimal adapter = new AdapterAnimal(this, claseBD.searchAnimales("PATAS","4"));
    ...
    private void setToolbar(androidx.appcompat.widget.Toolbar toolbar) {
        ...
        getSupportActionBar().setTitle("Animales con 4 patas");
