...
public class listarAnimalesAcuaticos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_animales_acuaticos);

        toolbar = findViewById(R.id.toolbar_acuaticos);
        animales = findViewById(R.id.rcv_animalesAcuaticos);
    ...
    private void mostrarTodosAnimales(String condicionOrdenar) {
        ...
        AdapterAnimal adapter = new AdapterAnimal(this, claseBD.searchAnimales("TIPO","acuático"));
    ...
    private void setToolbar(androidx.appcompat.widget.Toolbar toolbar) {
        ...
        getSupportActionBar().setTitle("Animales Acuaticos");
